...
const { createOrRetrieveChat, getChatDataById, createChat } = require('../controllers/chatControllers/chatControllers')
...
router.route('/createOrRetrieveChat').post(protectPath, createOrRetrieveChat)
